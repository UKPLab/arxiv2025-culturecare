...
# arxiv2025_culturecare
[![Arxiv](https://img.shields.io/badge/Arxiv-YYMM.NNNNN-red?style=flat-square&logo=arxiv&logoColor=white)](https://put-here-your-paper.com)
[![License](https://img.shields.io/github/license/UKPLab/arxiv2025-culturecare)](https://opensource.org/licenses/Apache-2.0)
...
To import classes/methods of `arxiv2025_culturecare` from inside the package itself you can use relative imports: 
...
```py
from arxiv2025_culturecare import BaseClass # Notice how I omit the file name
from arxiv2025_culturecare.subpackage import SubPackageClass # Here it's necessary because it's a subpackage
...
This is how you can use `arxiv2025_culturecare` from command line:

```bash
$ python -m arxiv2025_culturecare
```
